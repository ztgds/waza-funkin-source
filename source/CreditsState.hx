...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Waza Mod'],
			['ztgds','pixel','Everything except the\nCamera Note Follow Script','https://www.youtube.com/channel/UCUmuZE0RPjvUhB036T6omfQ', 'F73838'],
			['Washo789','pixel','Camera Note Follow Script','https://gamebanana.com/members/1971029', 'F73838'],
			[''],
		    ['Android Port'],
